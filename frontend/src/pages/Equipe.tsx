...
import { authService, teamService, type TeamMember } from "@/services";
...
export default function Equipe() {
  ...
  const handleSaveEdit = async () => {
    ...
    setSaving(true);
    try {
      await teamService.update(editingMember.id, {
  ...
  const handleCreateUser = async () => {
    ...
    try {
      await authService.adminCreateUser({
        ...
        organizationId: profile?.organization_id || activeOrganization?.id || undefined,
      });
